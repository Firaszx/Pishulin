...
namespace WebApExample.Controllers
{
    public class CarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarId,CarName,CarType,MaxPasNum")] Cars cars)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarId,CarName,CarType,MaxPasNum")] Cars cars)
        {
            if (id != cars.CarId)
            {
                return NotFound();
